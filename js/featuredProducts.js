// ! Products card featured product & new arrivals under shop section
...
const container = document.querySelector("#featuredProduct");
const container2 = document.querySelector("#pro-container");
...
// New Arrivals
function createCard2(item, cont) {
  let pro = document.createElement("div");
  pro.classList.add("pro");
